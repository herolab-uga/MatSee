...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 8 13:58:55 2022
...
def run_split():
    ...
    val_ratio = 0.2
    for c in classes:
        rgb_files = glob.glob(os.path.join(GEN_DIR, c, '/*_crop.png'))
        #rgb_files = glob.glob(os.path.join(GEN_DIR, c, '/*[0-9].png'))
        rgb_files.sort()
        depth_files = glob.glob(os.path.join(GEN_DIR, c, '/*_depthcrop.png'))
        #depth_files = glob.glob(os.path.join(GEN_DIR, c, '/*_depth.png'))
        depth_files.sort()
