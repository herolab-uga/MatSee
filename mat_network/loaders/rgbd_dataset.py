...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 8 20:18:24 2022
...
class RGBDDataset(torch.utils.data.Dataset):
    def __init__(self, data_root, rgb_extension='png', d_extension='exr', 
        ...
        for idx, class_name in enumerate(self.classes):
            ...
            print(class_path)
            #rgb_files = glob.glob(os.path.join(class_path + "/*[0-9].png"))
            #d_files = glob.glob(os.path.join(class_path + "/*_depth.png"))
            rgb_files = glob.glob(os.path.join(class_path + "/*_crop.png"))
            d_files = glob.glob(os.path.join(class_path + "/*_depthcrop.png"))
